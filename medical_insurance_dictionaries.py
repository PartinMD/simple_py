# Create initial database and populate
medical_costs = {}
...
# Fix an incorrect entry in the data
...
# Remove Vinay from the database
medical_records.pop("Vinay")
#print(medical_records)

# Create a "for" loop  to print unique messages
